...
test('undo error when uncommitted changes exist', async () => {
    const tmpDir = await mkdtemp(join(tmpdir(), 'alcom-undo-dirty-'));
    ...
    try {
        ...
        // Create uncommitted changes after the snapshot
